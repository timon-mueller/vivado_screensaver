...
#Movement switches
set_property -dict {PACKAGE_PIN R14 IOSTANDARD LVCMOS33 } [get_ports {gpio_rtl_0_tri_i[0]}];
set_property -dict {PACKAGE_PIN N16 IOSTANDARD LVCMOS33 } [get_ports {gpio_rtl_0_tri_i[1]}];
#Edge switch
